...
public class Attribute implements Map.Entry<String, String>, Cloneable {
	...
	public Attribute(String key, String val, Attributes parent) {
		...
		this.key = key.trim();
		Validate.notEmpty(key); // trimming could potentially make empty, so validate here 只要把第一行的验证改为notBlack验证即可避免此问题
		this.val = val;
		this.parent = parent;
	}
	...
	public void setKey(String key) {
		...
		// 感觉这里处理的不够好，应该只是给parent个通知，具体怎么处理让它自己看着办，这块更新的逻辑本该是parent持有
		if (parent != null) {
	...
	public boolean equals(Object o) { // note parent not considered
		...
		return (key != null ? key.equals(attribute.key) : attribute.key == null) && (val != null ? val.equals(attribute.val) : attribute.val == null);
	}
